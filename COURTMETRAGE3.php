...
<br>
<center>
    <IFRAME SRC="https://uqload.io/embed-8idf0v2zxpjj.html" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=1000 HEIGHT=562 allowfullscreen></IFRAME>
    <h4>FUNFAIR'S TOM</h4>
    <br>

    <?php
    $sql = "UPDATE `streaming` SET vues = vues+1 WHERE id = 17";
    $conn->query($sql);

    $sql = "SELECT vues FROM `streaming` WHERE id = 17";
