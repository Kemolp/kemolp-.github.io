...
<br>
<center>
    <IFRAME SRC="https://uqload.io/embed-5meelvdqrazt.html" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=1000 HEIGHT=562 allowfullscreen></IFRAME>
    <h4>EPISODE 2</h4>
    </div>
    <br>
    <?php
    $sql = "UPDATE `streaming` SET vues = vues+1 WHERE id = 2";
    $conn->query($sql);

    $sql = "SELECT vues FROM `streaming` WHERE id = 2";
