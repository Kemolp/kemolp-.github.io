...
<br>
<center>
    <IFRAME SRC="https://uqload.io/embed-dm16uabxl54h.html" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=1000 HEIGHT=562 allowfullscreen></IFRAME>
    <h4>LE VOYAGEUR</h4>
    <br>

    <?php
    $sql = "UPDATE `streaming` SET vues = vues+1 WHERE id = 15";
    $conn->query($sql);

    $sql = "SELECT vues FROM `streaming` WHERE id = 15";
