...
<br>
<center>
    <IFRAME SRC="https://uqload.io/embed-x00mo65jfih1.html" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=1000 HEIGHT=562 allowfullscreen></IFRAME>
    <h4>WANDERNDER RITTER</h4>
    <br>

    <?php
    $sql = "UPDATE `streaming` SET vues = vues+1 WHERE id = 16";
    $conn->query($sql);

    $sql = "SELECT vues FROM `streaming` WHERE id = 16";
