...
<br>
<center>
    <IFRAME SRC="https://uqload.io/embed-2f32wa8q6tdx.html" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=1000 HEIGHT=562 allowfullscreen></IFRAME>
    <h4>EPISODE 7</h4>
    </div>
    <br>
    <?php
    $sql = "UPDATE `streaming` SET vues = vues+1 WHERE id = 7";
    $conn->query($sql);

    $sql = "SELECT vues FROM `streaming` WHERE id = 7";
