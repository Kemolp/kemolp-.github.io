...
<br>
<center>
    <IFRAME SRC="https://uqload.io/embed-08hv8f60u7r4.html" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=1000 HEIGHT=562 allowfullscreen></IFRAME>
    <h4>EPISODE 6</h4>
    </div>
    <br>
    <?php
    $sql = "UPDATE `streaming` SET vues = vues+1 WHERE id = 6";
    $conn->query($sql);

    $sql = "SELECT vues FROM `streaming` WHERE id = 6";
