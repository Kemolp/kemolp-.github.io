...
<br>
<center>
    <IFRAME SRC="https://uqload.io/embed-oe4bgvdobql8.html" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=1000 HEIGHT=562 allowfullscreen></IFRAME>
    <h4>EPISODE 3</h4>
    </div>
    <br>
    ...
    $sql = "UPDATE `streaming` SET vues = vues+1 WHERE id = 11";
    $conn->query($sql);

    $sql = "SELECT vues FROM `streaming` WHERE id = 11";
