...
<br>
<center>
    <IFRAME SRC="https://uqload.io/embed-p7cfu8hf65v7.html" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=1000 HEIGHT=562 allowfullscreen></IFRAME>
    <h4>EPISODE 5</h4>
    </div>
    <br>
    <?php
    $sql = "UPDATE `streaming` SET vues = vues+1 WHERE id = 5";
    $conn->query($sql);

    $sql = "SELECT vues FROM `streaming` WHERE id = 5";
